"""
SOLAX: a JAX-based package for fermionic quantum many-body systems,
built around second-quantized operators acting on bases of Slater
determinants (occupation-number bitstrings), with NN-assisted support
for exploring big/intractable basis sets that cannot be enumerated
exhaustively. See SciPost Phys. Codebases 51 for the full design.
